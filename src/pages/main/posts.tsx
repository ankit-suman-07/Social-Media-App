        ...
        <div className="post">
            <table>
                ...
                <tr className="userRow">
                    <td></td>
                    <td  colSpan={2} className="user"> - @{ post.username }
                    
                    </td>
                    <td className="imgTD"><img  className="postImg" src={user?.photoURL || ""}  /></td>
                </tr>
                <tr>
                    <td  colSpan={3} className="descriptionCol" >{ post.description }</td>
                </tr>
                <tr  className="likesRow">
                    <td className="likes">
